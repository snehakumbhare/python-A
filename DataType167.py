...
# Define a function called 'strings_to_listOflists' that converts a list of strings into a list of lists, 
#where each character of a string is a separate element in a sublist.
